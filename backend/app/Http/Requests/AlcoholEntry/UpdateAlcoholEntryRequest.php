...
class UpdateAlcoholEntryRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'alcohol_type' => ['sometimes', 'string', Rule::in(AlcoholType::values())],
            'amount_ml' => ['sometimes', 'integer', 'min:1', 'max:5000'],
            'drink_date' => ['sometimes', 'date', 'before_or_equal:today'],
